...
$sql = "update Users set fname = '$fname', lname = '$lname', password = '$password', student = '$student', admin = '$admin' where userid = '$userid'";
//echo($sql);
...
echo ("
  <form class=\"form\" method=\"post\" action=\"user_update?sessionid=$sessionid\">
